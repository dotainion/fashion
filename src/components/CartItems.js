...
export const CartItems = () =>{
    ...
    return(
        <div 
            className="navigation-dropdown cart-item-container float-top-right" 
            onClick={e=>e.stopPropagation()}>
            <div className="cart-item-header-and-footer">
                <div>Products in cart</div>
            </div>
            <div className="cart-item-sub-container scroll">
            ...
            <div hidden={!cartItems?.length} className="cart-item-header-and-footer">
                <div><b>Sub Total: </b>{"$"}{cartItemsTotal}</div>
                <button onClick={()=>navigate(routes.deliveryOptions)} className="cart-item-checkout">CHECKOUT</button>
            </div>
